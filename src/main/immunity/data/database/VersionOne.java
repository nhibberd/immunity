...
public class VersionOne implements Patch {
    ...
    public List<String> changes() {
        return Arrays.asList(
                "create table if not exists blog ( title varchar(250), content varchar(5000), type varchar(50), link varchar(250), timestamp BIGINT, id SERIAL UNIQUE, authorid INTEGER, image varchar(50) )",
